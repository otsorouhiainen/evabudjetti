    ...
    <View style={styles.container}>
      <YStack backgroundColor="$background" style={styles.card}>
        ...
        <View style={styles.inputsContainer}>
            ...
            >
              {REOCCURENCE_OPTIONS.map((opt) => (
                ...
                >
                  <Button
                    backgroundColor={
                      reoccurence === opt ? "$primary200" : "$primary300"
                    }
                  ...
                  >
                    <SizableText
                      color={reoccurence === opt ? "$white" : "$primary100"}
                      size="$title3"
                    >
          ...
          <View style={{ paddingTop: 10, gap: 5 }}>
            ...
            >
              ...
              <Checkbox
                onCheckedChange={() =>
                  hasEndDate ? setEndDate(null) : setEndDate(new Date())
                }
        ...
        <View style={styles.buttonRow}>
          <Button
            borderRadius={28}
            backgroundColor={isDisabled ? "$primary300" : "$primary200"}
            style={styles.button}
            onPress={handleAdd}
            disabled={isDisabled}
          >
