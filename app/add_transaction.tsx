      ...
      <PortalProvider>
        ...
        >
          ...
          <YStack style={{ height: "100%" }} alignItems="center">
            ...
            >
              {/* Top header */}
              <XStack mt={"$7"} alignItems="center" justifyContent="center">
              ...
              >
                <YStack>
                  <SizableText size={"$title3"}>
                    ...
                    <SizableText size={"$title3"}> *</SizableText>
                  </SizableText>
                  <Input
                    value={name}
                ...
                <YStack>
                  ...
                  <Input
                    ...
                    height={40}
                    borderRadius={6}
                    borderColor={errors.amount ? "$danger500" : "$black"}
                    focusStyle={{
                      outlineColor: "transparent",
                    }}
                    px="10px"
                  ...
                  />
                  {errors.amount && (
                    <SizableText size={"$title3"} color="$danger500">
                      {errors.amount}
                    </SizableText>
                  )}
                </YStack>
                ...
                <XStack>
                  ...
                  <MultiPlatformDatePicker value={date} onChange={setDate} />
                </XStack>
              </YStack>
