...
export default function Budget() {
  ...
  const { past, future } = useMemo(() => splitTransactions(transactions), [transactions]);
            ...
            <Tab title="Kuukausi">
              ...
              >
                ...
                >
                  ...
                  <Card disabled style={styles.totalCard}>
                    <TouchableOpacity
                      ...
                      <View style={styles.totalRight}>
                        ...
                        >
                          {formatCurrency(POSITIVE_TX.reduce(
                  ...
                  <Card disabled style={styles.totalCard}>
                    <TouchableOpacity style={styles.totalHeader}
                      onPress={() =>
                        setExpensesOpen((v) => !v)
                      }
                      activeOpacity={0.8}
                    >
                      ...
                      <View style={styles.totalRight}>
                        ...
                        >
                          {formatCurrency(NEGATIVE_TX.reduce(
                    ...
                    <View style={styles.modalOverlay}>
                      <View style={styles.modalBox}>
                        ...
                        >
                          ...
                          rahamäärää, joka jää
                          jäljelle tulojen ja menojen
                          jälkeen. Se auttaa sinua
                          ymmärtämään, kuinka paljon
                          rahaa sinulla on
                  ...
                  <View style={styles.listWrap}>
                    {future.map((t) => (
                      ...
                      >
                        ...
                        >
                          <Text
                            style={[styles.pillAmt,
                              {
                                color: t.amount >= 0 ? '#138a5b' : '#1c1c1c'
                              }]}
                          >
                            {t.amount >= 0 ? '+' : ''}
                            {t.amount}€
                  ...
                  {editOpen && (
                    <View style={styles.modalOverlay}>
                      <View style={styles.modalBox}>
                        <Text category="h6">Edit Transaction</Text>
                        <Input 
                          label="Name" 
                          value={editingTxn?.name}
                          style={{ marginVertical: 8 }}
                          onChangeText={(text) => setEditingTxn((prev) => prev ? { ...prev, name: text } : prev)}
                        />
                        <Input
                          label="Amount (€)"
                          ...
                          onChangeText={(text) =>
                            setEditingTxn((prev) => prev ? { ...prev, amount: Number(text) }: prev)}
