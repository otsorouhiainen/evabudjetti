    ...
    resources: {
        en: {
            translation: {
                ...
                "Water": "Water",
                "Enter correct date in the format DD-MM-YYYY": "Enter correct date in the format DD-MM-YYYY",
                "Add new": "Add new",
                "Category": "Category",
                ...
                "Enter the recurrence interval": "Enter the recurrence interval",
                ...
                "Invalid date, use format: dd.mm.yyyy": "Invalid date, use format: dd.mm.yyyy",
                "Day": "Day",
                "Day view": "Day view",
                "Month": "Month",
                "Incomes": "Incomes",
                ...
                "Balance": "Balance",
                "Available": "Available",
                "Help Disposable income": "Disposable income refers to the amount of money left after your income and expenses. It helps you understand how much money you have available for other expenses or savings during the month.",
                "Close": "Close",
                ...
                // LANDING
                "Help": "Help",
                "Welcome to the budgeting app!": "Welcome to the budgeting app! ...",
                "CLOSE": "CLOSE",
                "Supporting your financial well-being": "Supporting your financial well-being",
            ...
            translation: {
                ...
                "Electricity": "Sähkö",
                "Water": "Vesi",
                "Enter correct date in the format DD-MM-YYYY": "Anna oikea päivämäärä muodossa pp.kk.vvvv",
                "Add new": "Lisää uusi",
                "Category": "Kategoria",
                ...
                "Invalid date, use format: dd.mm.yyyy": "Virheellinen päivämäärä, käytä muotoa: pp.kk.vvvv",
                "Day": "Päivä",
                ...
                "Help": "Ohjeet",
                "Help Disposable income": "Käyttövara tarkoittaa rahamäärää, joka jää jäljelle tulojen ja menojen jälkeen. Se auttaa sinua ymmärtämään, kuinka paljon rahaa sinulla on käytettävissä muihin menoihin tai säästöihin kuukauden aikana.",
                "Close": "Sulje",
                ...
                // LANDING
                "Welcome to the budgeting app!": "Tervetuloa budjettisovellukseen! ...",
                "Supporting your financial well-being": "Taloudenhallintasi tueksi",
